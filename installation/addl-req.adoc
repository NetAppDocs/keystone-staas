...
. ONTAP 9.8 or later
. Active IQ Unified Manager (Unified Manager) later than 9.10 and earlier than 9.16P2
...
. Ensure that Unified Manager later than 9.10 and earlier than 9.16P2 is configured. For information about installing Unified Manager, see these links:
+
