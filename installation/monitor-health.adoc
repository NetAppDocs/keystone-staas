...
summary: You can monitor the system health of the Keystone Collector by using any monitoring system that supports HTTP requests.
---
...
[.lead]
You can monitor the system health of the Keystone Collector by using any monitoring system that supports HTTP requests.
