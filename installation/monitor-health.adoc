...
= Health monitoring for Keystone Collector
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
. When the file is downloaded, you can attach it to the Keystone ServiceNow support ticket. For information about raising tickets, see link:../concepts/support-services.html[Generating service requests].
