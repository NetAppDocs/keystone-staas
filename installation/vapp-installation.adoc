...
vCentre versions prior to 8.0u are unable to automatically verify the authenticity of the code signing certificate. vCentre 8.0u and later can perform the verifications, however, for this, the signing certificate authority should be added to vCentre. Follow these instructions for your version of vCentre:
+
.vCentre 7.x and earlier: Learn more
[%collapsible]
====
