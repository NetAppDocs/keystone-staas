...
Verification of certificates against public root Certificate Authorities (CA) is a part of the Keystone Collector security features. However, if required, you can configure Keystone Collector to trust a custom root CA.
