...
* For the option `Remove Private Data`, see link:../installation/configuration.html#limit-collection-of-private-data[Limit collection of private data].
====
+
...
* For the option `Remove Private Data`, see For the option `Remove Private Data`, see link:../installation/configuration.html#limit-collection-of-private-data[Limit collection of private data].
====
+
