...
The Keystone Collector TUI configuration screen has the option *Remove Private Data* that limits the collection of specific customer data. This option is enabled by default.
