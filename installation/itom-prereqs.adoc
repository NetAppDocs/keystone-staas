...
* Supported operating system: Debian 12, Windows Server 2016, Ubuntu 20.04 LTS, ##Red Hat Enterprise Linux (RHEL) 9.0##, Amazon Linux 2023, or newer versions of these operating systems.
+
