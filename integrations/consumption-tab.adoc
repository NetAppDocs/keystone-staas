...
##is this correct-By default, please confirm-the graph displays the last 30 days of historical consumption and a 120-day projection from the current date on the same chart.## Up to 30 data points are plotted in total (20 for historical data and 10 for forecast data), with a vertical line separating the two segments.
