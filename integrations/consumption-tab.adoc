...
+
The following colors in the bar charts indicate the consumed capacity as defined within the performance service level. Monthly data across the charts is separated by a vertical line.
+
** Green: Within 80%.
** Amber: 80% - 100%.
