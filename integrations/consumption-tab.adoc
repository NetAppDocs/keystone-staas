...
+
image:consumption-trend-burst[screenshot displaying historical consumption]  
+
...
You can view projected capacity usage for the next 120 days through the *Forecast* toggle available in the *Historical consumption* view of the *Consumption trend* tab in the Console. The toggle is enabled by default.

By default, the graph displays the last 30 days of historical consumption alongside a 120-day projection. Up to 30 data points are plotted in total (20 for historical data and 10 for forecast data), with a vertical line demarcating the two segments.
