...
[.lead]
On the *Volumes & Objects* tab, you can view the volume snapshot and details for your ONTAP volumes. For StorageGRID, this tab displays the nodes and their individual usage in your object storage environment.
