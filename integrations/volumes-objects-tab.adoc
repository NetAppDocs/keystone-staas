...
* ##For subscriptions that cover service levels for both file and object, you can view the object storage details by clicking the *Object Storage Details* button.##
====
