...
[.lead]
The Keystone dashboard in BlueXP provides a timeline view of your Keystone subscriptions, displaying events such as activation, modification, and renewal dates. This timeline view is not available in the Digital Advisor.
...
+
image:subscription-timeline.png[a screenshot to show subscription timeline in a line graph format along with important event]
+
