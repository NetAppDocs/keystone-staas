...
##You can search for Keystone subscription details by searching by a customer name or a watchlist name that includes multiple customers or nodes. For information about how to search by watchlists, see ##
...
== Searching Keystone customers or subscriptions by using watchlists
...
For Keystone, you can create watchlists to include systems of multiple customers and node serial numbers. 



when you create watchlists for Keystone customers, you can add Keystone customer names and select them from the available options on the list. 
After you have created a watchlist, you can search for the watchlist name. The customers in the watchlist are available for selection from the Subscription drop-down list on the Keystone Subscriptions widget. 
