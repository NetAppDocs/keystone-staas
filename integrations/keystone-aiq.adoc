...
You can search for Keystone subscription details by searching by a customer name or a watchlist name that includes multiple customers. For information about watchlists, see https://docs.netapp.com/us-en/active-iq/concept_overview_dashboard.html[Understand watchlist].

[TIP]
If you search for a watchlist that includes multiple customers, the customers in the watchlist are available for selection from the *Subscription* drop-down list on the *Keystone Subscriptions* widget.
