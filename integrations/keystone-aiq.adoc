...
* *Service Level Agreement*: This status appears if at least one of your subscriptions has a valid sustainability, performance, or availability service level agreement (SLA) with NetApp. You can look at the icons adjacent to the subscription to determine whether the subscription meets the sustainability, performance, or availability criteria defined in your SLA. The image:green-check.png[green tick] icon indicates that the subscription meets the criteria, while the image:red-warning.png[warning] icon indicates that the subscription breaches the SLA criteria.
...
image:new-db-1.png[new dashboard]
