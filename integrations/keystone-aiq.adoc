...
[NOTE]
If you have created watchlists for your subscriptions, you can see the details of all the subscriptions that you have configured in the watchlists. For information about watchlists, see https://docs.netapp.com/us-en/active-iq/concept_overview_dashboard.html[Understand watchlist].
