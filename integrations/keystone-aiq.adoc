...
[NOTE]
##Your consumption data can be retrieved by Keystone Collector or AutoSupport telemetry. If AutoSupport is used, you can see the timestamp of the consumption data in UTC time.##
