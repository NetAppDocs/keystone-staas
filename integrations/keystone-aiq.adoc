...
For Keystone, you can create watchlists to include systems of multiple customers. Follow these steps:
...
. Search for the required customers by their names and add them.
...
[TIP]
If you are on the new dashboard on the *Keystone Subscriptions* widget, click *Switch to New Dashboard* to view the list.