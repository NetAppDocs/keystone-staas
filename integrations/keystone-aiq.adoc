...
To learn more about usage metrics, refer to link:../concepts/metrics.html[Metrics measurement]. For information about different capacities used in Keystone, see link:../concepts/supported-storage-capacity.html[Storage capacity types in Keystone].
