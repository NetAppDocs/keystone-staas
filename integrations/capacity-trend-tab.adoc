...
##If you have selected the *Invoiced Accrued Burst* option, you can see accrued burst usage data on a monthly or quarterly basis, depending on your selected billing period, for the last 12 months that have been billed. You can query by the date range for up to past 30 months. Bar charts display the invoiced data, and if the usage has not yet been billed, it will be marked as _Pending_ for that period.##
...
##For a quarterly billing period, if the subscription starts on a date other than the 1^st^ of the month, the quarterly invoice will cover the subsequent 90-day period. The reporting for burst usage will remain aligned with the calendar month. Therefore, two invoices will be generated for the last month of the quarter to provide complete details for the entire month. For example, if the subscription begins on May 15, the quarterly invoice will cover May 15 to August 14, and there will be two invoices for August: one for August 1 to 14 and another for the new quarterly period starting from August 15.##
