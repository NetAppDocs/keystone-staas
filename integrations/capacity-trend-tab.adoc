...
== ##View daily accrued burst usage data##
##You can view daily accrued burst usage data for a monthly or quarterly billing period. When you click the bar that displays the invoiced data, the Billable Provisioned Capacity section will appear below the bar chart, offering you *Graph* and *Table* viewing options. The default *Graph* view displays burst usage data in a line graph format, showing changes in usage over time.##
