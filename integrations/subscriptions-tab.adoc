...
* *Linked subscriptions*: ##If you have any secondary subscriptions linked to your primary subscription, this column lists the linked subscription numbers for the primary subscription. To learn more about linked subscriptions, refer to link:../concepts/linked-subscriptions.html[Learn about linked subscriptions in Keystone] and link:../integrations/view-linked-subscriptions.html[View and monitor linked Keystone subscriptions].##
