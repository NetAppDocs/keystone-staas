...
+
##For subscriptions with auto-renewal on, an auto-renewal icon is displayed, indicating the subscription will renew automatically at the end of the current term.##
+
