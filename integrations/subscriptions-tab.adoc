...
+
NOTE: ##You can click the down arrow next to the *Expiration date* column to expand performance service levels for each subscription. This shows detailed capacity information including current usage, committed capacity, provisioned capacity, burst capacity, and available capacity.##
+
