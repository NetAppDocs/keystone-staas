...
+
image:subscription-tab-bluexp-1.png[view thw subscription tab details]
+
...
. You can select the *Performance service levels* sub-tab to view the service levels across all subscriptions, along with detailed information presented in the table.
+
image:performance-levels-bluexp-1.png[view performance service levels across all subscriptions]
+
* *Performance levels across subscriptions*: Displays the number of subscriptions for each service level, with *View* button to filter the table.
