...
[.lead]
To monitor the performance of your systems, you can view performance metrics of the ONTAP volumes managed by your Keystone subscriptions through Digital Advisor.
