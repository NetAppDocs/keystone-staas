...
* ##The *View* dropdown options depend on your storage platforms. *Volumes in clusters* and *Nodes in clusters* are available for ONTAP. *Nodes in grids* is available for StorageGRID.##
====
