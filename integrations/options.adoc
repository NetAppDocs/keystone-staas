...
[.lead]
The Keystone dashboard, accessible through BlueXP and Digital Advisor, provides options to search and filter your data, generate reports for subscriptions and usage, check timestamps to ensure your data is current, and view alerts to stay informed about your storage environment. Some of these options are available only in BlueXP or Digital Advisor.
