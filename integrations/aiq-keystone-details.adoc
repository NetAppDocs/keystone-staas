...
+
* *Current Consumed*: Indicator for the consumed capacity (in TiB) defined for the service level. This field uses specific colors for usage. For burst usage, no color is displayed in this field.
** Grey: None.
