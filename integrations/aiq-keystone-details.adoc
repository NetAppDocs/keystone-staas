...
image:mcc-chart-mirror.png[split chart]

For the _Advanced Data-Protect Extreme_ service level, the chart appears like this at the same collection point:

image:adp-mir.png[data protection SL chart]
...
+
[NOTE]
For Advanced Data Protection add-on services, an additional column appears to indicate whether the volume is a primary or mirror volume in the MetroCluster configuration. You can copy individual node serial numbers by clicking the *Copy Node Serials* button. 
