...
. Select the year and month for which you want to view the details. By default, he data for the current month is displayed. You can select the year and month during which the subscription has been active.
