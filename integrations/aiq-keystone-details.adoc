...
For the _Advanced Data-Protect Extreme_ service level, the charts appear like this:
...
For the _Advanced Data-Protect Extreme_ service level and the same data collection point, the chart appears like this:
