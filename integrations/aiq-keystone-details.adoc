...
* *Subscription Number*: The subscription number of the Keystone subscription assigned by NetApp. ##This subscription number might be your primary subscription number or a subscription linked to your primary subscription.##
* ##*Linked Subscriptions*: This column lists any secondary subscription numbers that are linked to the primary subscription in the *Subscription Number* field.##
