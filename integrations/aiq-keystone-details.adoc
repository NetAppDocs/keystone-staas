...
##You can generate and view a consolidated report for your subscriptions, historical usage, burst usage, performance, assets, and volumes and objects at the customer, cluster, watchlist, or subscription level by selecting *Keystone Subscriptions* as the report type from the Report feature in Digital Advisor. To learn more about generating reports, refer to link:https://docs.netapp.com/us-en/active-iq/task_generate_reports.html[Generate custom reports^].##

##The report is generated in Excel format, with each type of information, such as subscription details or usage history, displayed in separate sheets named according to the tabs on the *Keystone Subscriptions* page for easy viewing. You can save the report for future use.##

##A sample consolidated report with subscriptions details in one sheet:##
