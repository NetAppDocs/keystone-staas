...
[%collapsible]
====
If you have subscribed to the advanced data protection (ADP) add-on service, you can view the breakup of the consumption data for the MetroCluster partner sites on the *Subscription Time Series* tab. 

For information about advanced data protection add-o service, see link:../concepts/adp.html[Advanced Data Protection].
...
+
[NOTE]
You can copy individual node serial numbers by clicking the *Copy Node Serials* button. 
