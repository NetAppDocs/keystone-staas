...
.What you can see at the primary site
...
.What you see at the mirror site

When you check the subscription for the mirror site, you can see the bar chart for the _Extreme_ service level at the same data collection point is reversed, and the consumption breakup at the primary and mirror sites is 1.05 TiB and 1.02 TiB respectively.
