...
The *Availability SLA* tab provides you with the availability SLA details.

.Steps
. Click *SLA Details > Availability SLA*.
. Select the required subscription and volume for which you want to view the details. You can view only those subscriptions that meet the criteria for availability SLA. For information about the criteria, see link:../concepts/sla-sustainability.html#eligibility-criteria-for-sustainability-sla[Eligibility criteria for sustainability SLA].
...
The *Performance SLA* tab provides you with the sustainability SLA details.
