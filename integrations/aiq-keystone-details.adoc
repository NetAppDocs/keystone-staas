...
You can click the toggle button *Show Current Usage* to view the current consumption and burst usage with respect to the billing period of the subscription. These are not based on the date range of the query.
