...
== Subscriptions tab: view all your subscriptions
...
== Current Usage tab: view usage details
...
== Capacity Trend tab: view historical usage 
...
== Volumes & Objects tab: view volumes and objects details
...
== Performance tab: view ONTAP volume performance 
