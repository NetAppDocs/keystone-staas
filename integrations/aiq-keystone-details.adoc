...
* Ambient temperature: If the temperature is outside of the range of 25-27 ^o^C.
* SLA Watts/TiB: If the service level SLA is not met. For information, see link:../concepts/sla-sustainability.html#sustainability-service-level[Sustainability service level].
