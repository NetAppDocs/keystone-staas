...
* *Monitor subscription details*: View detailed information about your Keystone subscriptions, including performance service levels (base and add-on services such as advanced data protection and Data Infrastructure Insights), capacity usage, assets, and alerts.
