...
* *Monitor subscription details*: ##View detailed information about your Keystone subscriptions, including performance service levels (base and add-on services such as advanced data protection and Data Infrastructure Insights), capacity usage, assets, and alerts. For linked subscriptions, you can also monitor how consumption is distributed across primary and secondary subscriptions.##
...
* While the Console and Digital Advisor offer some exclusive features, the Console provides administrative functionality for Keystone, allowing you to manage subscriptions and make necessary adjustments. To learn more, refer to link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-keystone-roles.html[Keystone access roles in NetApp Console^].
...
|Yes
|Yes
a|##link:../integrations/view-linked-subscriptions.html[View and monitor linked subscriptions]##
|##Yes##
|##Yes##
...
|Yes
|Yes
a|link:../integrations/adp-tab.html[View MetroCluster consumption and health]
|Yes (includes health status, topology view, and sync monitoring)
|Yes (consumption data only)
