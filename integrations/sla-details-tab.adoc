...
+
TIP: ##If your Keystone subscription is renewed or modified, you can select the previous month and year as a start date to view the historical SLA details.##
. Click *View Details*.
