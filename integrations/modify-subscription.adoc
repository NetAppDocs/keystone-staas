...
To change the data storage capacity, follow these steps:
...
+
You can track and monitor the progress of your request under the Administration tab. To learn more about the Administration tab tab, refer to <link>.
