...
+
image:monitoring-alerts-default-view-1.png[A screenshot of active alerts for Keystone subscriptions]
+
...
+
NOTE: ##Editing alerts requires the *Keystone admin* role. The *Keystone viewer* role can view alert details and add supporting notes. To learn more, refer to link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-keystone-roles.html[Keystone access roles in NetApp Console^].##
