...
+
NOTE: Editing alerts and requires the *Keystone admin* role. The *Keystone viewer* role can only view alert details. To learn more, refer to link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-keystone-roles.html[Keystone access roles in NetApp Console^].
