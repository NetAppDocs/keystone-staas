...
You can view the subscription and consumption details for your Keystone subscriptions through NetApp Console or Digital Advisor. To learn more about Keystone reporting, refer to link:../integrations/dashboard-overview.html[Keystone dashboard overview].
