...
= Learn about Keystone infrastructure
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
You can view the subscription and consumption details for your Keystone subscriptions through the NetApp Console or Digital Advisor. To learn more about Keystone reporting, refer to link:../integrations/dashboard-overview.html[Keystone dashboard overview].
