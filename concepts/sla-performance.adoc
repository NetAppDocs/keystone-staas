...
* Service credits might be applied to a future invoice. Service credits do not apply to expired Keystone subscriptions. To contact NetApp support and open the support case required for a service credit request, see link:../concepts/support-services.html[Support services for Keystone].
====