...
* Service credits might be applied to a future invoice. Service credits do not apply to expired Keystone subscriptions. To learn more, refer to link:../concepts/support-services.html[NetApp Keystone support].
====