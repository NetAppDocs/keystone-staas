...
* ^2^In an AFX cluster, performance targets apply per storage controller. Each controller added to the cluster contributes the same IOPS and throughput. Committed capacity and incremental increases apply to the total drive shelf capacity across the cluster.
====
