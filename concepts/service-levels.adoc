...
[TIP]
The detailed service description for NetApp Keystone STaaS is available https://www.netapp.com/pdf.html?item=/media/77179-Keystone-STaaS-Service-Description-On-Prem.pdf[here].
