...
[.lead]
##Understanding Keystone billing for specific configurations in version 3 (v3) can help you optimize service usage and manage costs. The configurations include cloned volumes, advanced data protection, temporary volumes, SnapMirror destinations, LUNs, and system/root volumes.##
