...
NOTE: ##<must review>The advanced data protection add-on service is available for unified storage on AFF storage arrays only (_Extreme_, _Premium_, and _Standard_ performance service levels). It is not supported on FAS storage arrays (_Value_ performance service level). ##
