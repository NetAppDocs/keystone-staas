...
Your burst limit is determined and specified in your Keystone agreement. ##It is usually set up to 20% above the committed capacity, with additional options available to select burst capacity limits of 40% or 60% of committed capacity.##
