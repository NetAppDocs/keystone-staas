...
[.lead]
The capacity requirements for Keystone STaaS performance service levels in version 2 differ with the file, block, object, or cloud storage supported by the Keystone STaaS subscription.
