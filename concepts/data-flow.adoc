...
image:collector-data-flow-1.png[shows data flow within collector components] 
...
##Keystone ITOM Monitoring Solution complies with the European Union General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA). It also provides a link:https://www.logicmonitor.com/legal/data-processing-addendum[Data Protection Addendum (DPA)^] to document these commitments. No personal data will be collected or stored by the ITOM monitoring solution.##
