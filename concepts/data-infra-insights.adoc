...
keywords: add-on services, add-on, data infrastructure insights, DII
...
* Approved NetApp Support team members can access the customer's DII instance if the customer enables the *Allow NetApp Access to your Data Infrastructure Insights Environment* option. To do so, go to *Help > Support*, and enable the option. Customers can also grant access to internal or external users by adding them.
