...
|===
##Once configured, the DII instance will begin monitoring the NetApp storage resources deployed as part of Keystone, with DII consumption being reported in the Digital Advisor dashboard as a service level.##
