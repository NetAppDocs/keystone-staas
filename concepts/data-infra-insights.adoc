...
= Data Infrastructure Insights add-on for Keystone
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
DII is available for both new and existing subscriptions. It can be integrated into a Keystone subscription as an add-on for the committed capacity.
...
To set up DII, refer to link:https://docs.netapp.com/us-en/data-infrastructure-insights/task_getting_started_with_cloud_insights.html[Data Infrastructure Insights onboarding^].

Note the following:

* If the customer is starting a new DII instance, it is recommended to begin with a link:https://docs.netapp.com/us-en/data-infrastructure-insights/concept_subscribing_to_cloud_insights.html#trial-edition[DII free trial^]. To learn about this feature and the required startup checklist, refer to link:https://docs.netapp.com/us-en/data-infrastructure-insights/concept_feature_tutorials.html[Feature Tutorials^].
...
You can view the consumption for your DII add-on services through the NetApp Console or Digital Advisor. The consumption data for DII performance service levels (such as DII Extreme, DII Premium, and DII Performance) appears alongside your base performance service levels in the current consumption and consumption trend views.

The following example shows DII performance service levels in the *Current consumption* tab in the Console:

image:console-current-consumption-dii.png[Screenshot of current consumption tab displaying DII service levels]

The following example shows DII performance service levels in the *Keystone Subscriptions* widget in Digital Advisor:

image:keystone-widget-dii.png[Screenshot of Keystone Subscriptions widget displaying DII service levels]

For more information about viewing consumption, see:
