...
Keystone STaaS, as a part of the SLA, ensures accurate assessment of your sustainability score by providing guaranteed measurements of the power consumption in your storage systems. Power efficiency is measured as actual watts per tebibyte (W/TiB) in your Flash storage systems. If there is a violation of the SLA, you are notified through alerts.
