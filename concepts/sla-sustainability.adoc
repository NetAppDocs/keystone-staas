...
[.lead]
##NetApp Keystone delivers a guaranteed measurement of maximum watts per tebibyte (W/TiB) per performance service level instance for unified (excluding Value performance service level) and block-optimized data storage types, or per AFX Cluster. Sustainability SLO defines the maximum power consumption per TiB for each eligible performance service level, helping organizations meet their sustainability goals.##

== Metrics

* *Watts*: ##The power consumed by the storage arrays, or AFX Cluster, as reported by the monitoring tool.##
...
|===
|*Service level* | *SLO criteria* |*Minimum committed capacity* |*##Platform (suggest AFX changes here)##*
a|
