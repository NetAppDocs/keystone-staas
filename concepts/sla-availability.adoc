...
* *Monthly uptime percentage* = [(number of eligible seconds in a month - average of number of seconds of downtimes of all AFF storage arrays deployed to deliver the Keystone order in that month) /  number of eligible seconds in a month] x 100%
...
Once GSSC has validated a breach, a service credit claim is to be submitted within six weeks, 
[NOTE]
====
