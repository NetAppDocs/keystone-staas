...
[.lead]
##Availability SLO targets an uptime of 99.999% per performance service level instance during a billing period for unified and block-optimized data storage types, or per AFX storage controller.##
