...
During onboarding, if you were provided credentials for accessing and using Netapp Keystone ServiceNow, you can use the portal to raise service requests for any service or system-related issues: 

https://netappgssc.service-now.com/csm 

Ensure that you have the system details, logs, and related information handy before raising the service request. When you raise a service request, the GSSC team receives the support ticket and accesses the information for troubleshooting. You can follow your ServiceNow ticket for the status and resolution. 
