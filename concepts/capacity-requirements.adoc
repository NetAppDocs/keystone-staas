...
* A burst capacity is available at each site, based on the Keystone agreement, for example, 20% or 50% above the committed capacity. Any burst usage is billed only for that billing period. If you need an additional burst requirements that is greater than the capacity agreed upon, contact support.
