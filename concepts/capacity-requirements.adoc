...
NOTE: For AFX storage, capacity is committed and measured at the AFX cluster level, across all drive shelves in the cluster. This is independent of the number of AFX storage controllers in the cluster.
