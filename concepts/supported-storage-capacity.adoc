...
During a subscription, you can change committed capacities subject to certain conditions. For full details on capacity increase and decrease rules, see link:../concepts/capacity-requirements.html[Capacity requirements for Keystone performance service levels]. To request a change, contact your Keystone Success Manager (KSM) or see link:../concepts/support-services.html[NetApp Keystone support].
