...
== Burst capacity
Any consumption exceeding the committed capacity for a service level is the burst capacity. The following points help you to understand burst consumption:

** Keystone service enables you to use additional capacity on top of the committed capacity for a service level. This is the burst capacity.
