...
* *Committed capacity decrease*: The committed capacity can be decreased based on certain conditions. This applies to Keystone on-premises service only if you have selected a subscription term of not less than 24 months. For information, see link:../concepts/capacity-requirements.html[Capacity reduction].
