...
a|In the *Consumption Trend* tab in Digital Advisor, the consumption trend chart does not display consumption data for the current day, showing data only through the previous day.
a|Fixed
a|August 10, 2026
//NSEKEY-26526
a|On the *Subscriptions* page in the NetApp Console, filtering by *Capacity status: Underutilized* incorrectly displays expired subscriptions.
a|Fixed
a|August 10, 2026
//NSEKEY-25969
a|On the *Subscriptions* page in the NetApp Console, the subscription table view does not reflect updates to *Provisioned Volume Capacity*.
a|Fixed
a|August 10, 2026
//NSEKEY-27340
a|Subscriptions incorrectly display *Above Burst Limit* status in the Digital Advisor dashboard despite consumption being within allowed burst limits.
a|Fixed
a|March 30, 2026
//NSEKEY-20670
