...
a|If the *Account Name* column in CSV reports generated from the *Capacity Trend* tab includes an account name with a comma _(",")_, Keystone data appears misplaced in CSV reports.
a|None
