...
The *Keystone Subscriptions* screen is updated to display the selected subscription across all tabs.
...
* If the selected subscription is not subscribed to the performance metrics, the *Performance* tab will display the first subscription listed in the *Subscription* dropdown upon navigation.
