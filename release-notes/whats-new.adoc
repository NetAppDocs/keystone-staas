...
=== Addition of daily burst data viewing options
You can now view daily accrued burst data in either graph or table format for a monthly or quarterly billing period by clicking the bar that displays the invoiced data. To learn more, refer to link:../integrations/capacity-trend-tab.html#view-daily-accrued-burst-usage-data[View daily accrued burst usage data]
//NSEKEY-11952
