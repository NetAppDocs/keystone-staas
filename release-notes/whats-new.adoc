...
== June 30, 2025
##You can now subscribe to Keystone version 3, the latest version of Keystone. This release introduces several enhancements, such as simplified performance service levels, expanded supported storage and capacity, and flexible billing frequency options. These improvements simplify the management, optimization, and scaling of storage solutions. To learn more, refer to link:../concepts/metrics.html[Keystone STaaS services for v3].##
