...
##You can now generate a consolidated report to view the details of your Keystone data using the Report feature in Digital Advisor. To learn more, refer to link:../integrations/aiq-keystone-details.html[Generate consolidated report^].##
//NSEKEY-5735
