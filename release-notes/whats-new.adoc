...
The Active IQ Digital Advisor (also known as Digital Advisor) dashboard and *Keystone Subscriptions* screen have been enhanced for this release:
...
To provide better clarity to your ONTAP system volumes, the *Volumes* tab is enhanced with two new tab buttons: *Volume Summary* and *Volume Details*. The *Volume Summary* tab provides an overall count of the volumes associated with your subscribed service levels. The *Volume Details* tab lists all the volumes and their specific details. For more information, see link:../integrations/volumes-objects-tab.html[Volumes & Objects tab^].
