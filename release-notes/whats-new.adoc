...
== New features and enhancements for May 09, 2024
The following enhancement are made on the *Keystone Subscriptions* screen of Active IQ Digital Advisor (also known as Digital Advisor):
...
//NSEKEY-9540
=== Object storage details within Volume Details tab
The *Volume Details* tab under the *Volumes & Objects* tab now provides object storage details along with volume information for subscriptions that cover service levels for both file and object. You can click the *Object Storage Details* button available with the *Volume Details* tab to view the details.

== New features and enhancements for March 28, 2024
The following enhancement has been made on the *Keystone Subscriptions* screen of Active IQ Digital Advisor:
