...
== June 30, 2025
##You can now subscribe to Keystone v3, the latest version of Keystone. This release introduces several enhancements, such as simplified performance service levels, expanded supported storage and capacity, and flexible billing frequency options. These improvements make it easier for customers to manage, optimize, and scale their storage solutions. To learn more, refer to link:../concepts/metrics.html[Keystone STaaS services for v3].##
