...
NOTE: ##Only the third-party packages listed above are supported on Keystone Collector. Installing additional software is not supported and may impact collector performance, data collection, and billing accuracy. To install specific software on Keystone Collector, contact NetApp Keystone support before proceeding.##
...
* Each month, export a file from Keystone Collector and email it to the NetApp support team. For more information on how to contact the support team, refer to link:../concepts/support-services.html[Get help with Keystone].
