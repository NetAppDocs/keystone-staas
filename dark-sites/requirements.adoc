...
= Installation requirements for Keystone Collector in private mode
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
NOTE: Only the third-party packages listed above are supported on Keystone Collector. Installing additional software is not supported and may impact collector performance, data collection, and billing accuracy.
...
* Each month, export a file from Keystone Collector and email it to the NetApp support team. For more information on how to contact the support team, refer to link:../concepts/support-services.html[Support services for Keystone].
