...
+
. Send an email with this file to ng-keystone-secure-site-upload@netapp.com for non-USPS secure sites, or to ng-keystone-secure-site-usps-upload@netapp.com for secure USPS sites.
...
. Collect the files and send them to ng-keystone-secure-site-upload@netapp.com for non-USPS secure sites, or to ng-keystone-secure-site-usps-upload@netapp.com for secure USPS sites.
+
