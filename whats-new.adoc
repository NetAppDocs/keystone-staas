...
[.big-heading]
*Performance Service Level Updates*
The following features and enhancements are introduced in the Keystone dashboard of BlueXP:
...
++++
<h3 style="text-align: left; color: #010000ff;">Performance service level updates</h3>
++++
