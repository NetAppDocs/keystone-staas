...
To get started, go to *Storage > Keystone* in the BlueXP left navigation menu. To learn more, refer to link:https://docs.netapp.com/us-en/keystone-staas/integrations/dashboard-overview.html[Keystone dashboard overview].
